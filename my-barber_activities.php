...
';  } 
 $alldata=barber_activities::read_barber_activities_2($_SESSION['user_id']); $column=barber_activities::barber_activities_constants(); 
 ...
 extract($_GET); 
  $alldata= barber_activities::check_between_dates_barber_activities_2($date1,$date2,$_SESSION['user_id']); 
 } 
 } 
  ?>
<center><b><?php
