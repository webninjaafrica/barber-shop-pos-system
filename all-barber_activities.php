...
include_once('head.php'); 
 ...
 <div class='col-sm-12 col-md-12 col-xs-12 col-lg-12'><ul class='breadcrumb'><li><a href='all-barber_activities.php'><i class='fa fa-list'></i>&nbsp;&nbsp;All BARBER ACTIVITIES</a></li> </ul>
 ...
 <div class='btn-group'><a href='add-barber_activities.php' class='btn btn-info'><i class='fa fa-plus'></i> ADD NEW</a><a class='btn btn-primary' href='all-barber_activities.php' class='btn btn-default'><i class='fa fa-refresh'></i> NEW CUSTOMER</a>
 ...
 <div class='input-group'><select name='type' class='form-control' required='required'><option value='user_id'>USER ID</option><option value='customer_names'>CUSTOMER NAMES</option><option value='customer_contacts'>CUSTOMER CONTACTS</option><option value='service_id'>SERVICE ID</option><option value='amount_charged'>AMOUNT CHARGED</option></select><input type='text' name='query' class='form-control' required='required'><button style='margin-left:4px;border:1px solid lightgrey;' name='check' type='submit' class='btn btn-info'><i class='fa fa-search'></i> SEARCH</button>
...
';  } 
 $alldata=barber_activities::read_barber_activities(); $column=barber_activities::barber_activities_constants(); 
 ...
 extract($_GET); 
  $alldata= barber_activities::check_between_dates_barber_activities($date1,$date2); 
 } 
 } 
  ?>
<center><b><?php
